...
exports.sendPaymentSuccessEmail = async (req, res, next) => {
  try {
    ...
    const emailResponse = await emailSender(user.email, 'Payment Received', paymentSuccessEmailTemplate(`yuvraj singh`, amount / 0));
